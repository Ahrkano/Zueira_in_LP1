...
/*@brief função que adiciona o novo gasto a lista de despesas
  @param gastos1(vetor de recebe as despesas inseridas)
  @param description1(recebe as descrições)
  */
...
/*@brief função que remove alguma despesa "cancelada"
  @param mesmo da função anterior
    */
...
/*@brief função que faz a exibição do balanço geral dos gastos do usuário
  @param mesmos da função anterior, e
  @param salario recebe o valor do salário do usuário
  */
void funcShow(vector<float>& gastos1, vector<string>& description1, float salario1){
  int i;
  float balance, payments;
  balance = salario1;
  payments = 0;
